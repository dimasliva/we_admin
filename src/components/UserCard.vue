  ...
  <div class="additional">
    <div class="user-card">
      ...
      <div class="points center">
        <input class="input money" v-model="user.money">
      </div>
    ...
    <div class="more-info">
      <input class="input h1" v-model="user.name">
      <div class="coords">
        <span>Создан</span>
        <span>{{ this.selectedItem.created_at }}</span>
      </div>
      <div class="coords">
        <span>Профессия</span>
      ...
      <div class="coords">
        <span>Возраст</span>
        <input class="input right" v-model="user.age" maxlength="3">
      </div>
      <div class="coords">
        <span>Вес</span>
        <input class="input right" v-model="user.weight" maxlength="3">
      </div>
      <div class="coords">
      ...
      <div class="stats">
        <div>
          ...
          <input class="input stat" v-model="user.health" maxlength="3">
        </div>
        <div>
          <div class="title">Голод</div>
          <i class="fa fa-gamepad"></i>
          <input class="input stat" v-model="user.hungry" maxlength="3">
        </div>
        <div>
          <div class="title">Сила</div>
          <i class="fa fa-group"></i>
          <input class="input stat" v-model="user.power" maxlength="3">
        </div>
        <div>
          <div class="title">Энергия</div>
          <i class="fa fa-coffee"></i>
          <input class="input stat" v-model="user.energy" maxlength="3">
        </div>
      </div>
    </div>
  </div>
</div>
  <EditButton @click="onEdit" v-show="selectedItem.id"/>
</div>
</template>
...
.card .additional .more-info h1, .input.h1 {
  color: #fff;
  margin-bottom: 10px;
  font-size: 26px;
}
...
.card .additional .stats div.value, .input.stat {
  font-size: 1.5rem;
  font-weight: bold;
  line-height: 1.5rem;
}
