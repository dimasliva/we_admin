  ...
  <div class="additional">
    ...
    <div class="more-info">
      ...
      <div class="coords">
        ...
        <span>{{ this.drivecategory }}</span>
      </div>
      <div class="stats">
        <div>
          <div class="title">ХП</div>
          <i class="fa fa-trophy"></i>
          <div class="value">{{this.health}}</div>
        </div>
        <div>
          <div class="title">Голод</div>
          <i class="fa fa-gamepad"></i>
          <div class="value">{{this.hungry}}</div>
        </div>
        <div>
          <div class="title">Сила</div>
          <i class="fa fa-group"></i>
          <div class="value">{{this.power}}</div>
        </div>
        <div>
          <div class="title">Энергия</div>
          <i class="fa fa-coffee"></i>
          <div class="value">{{this.energy}}</div>
        </div>
      </div>
    </div>
  </div>
